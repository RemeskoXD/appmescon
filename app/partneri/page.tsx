      ...
      <section className="page-container py-10 md:py-16 grid gap-10 md:grid-cols-2 items-center">
        ...
        <div className="relative mx-auto flex items-center justify-center">
          <div className="relative">
            ...
            <span className="absolute left-[22%] top-[38%] h-2 w-2 rounded-full bg-[#7ea6ff] shadow-[0_0_0_6px_rgba(88,133,250,.18)]" aria-hidden="true" />
            ...
            <span className="absolute left-[68%] top-[44%] h-2 w-2 rounded-full bg-[#8aaafc] shadow-[0_0_0_6px_rgba(88,133,250,.18)]" aria-hidden="true" />
          ...
          <span className="pointer-events-none absolute -inset-6 -z-10 rounded-[28px] bg-gradient-to-tr from-[#5885fa]/10 via-[#5885fa]/10 to-[#7ea6ff]/10 blur-2xl" aria-hidden="true" />
        </div>
      </section>
        ...
        <div className="page-container px-6 md:px-10">
          <div className="relative overflow-hidden rounded-xl border border-[#23283a] bg-[#10131d]/60 backdrop-blur-sm partner-rail">
            ...
            <div className="flex gap-10 animate-partner-marquee will-change-transform py-5 pl-6">
              {/* sekvence 1 */}
              {partners.map((n) => (
                <img key={`s1-${n}`} src={`https://web2.itnahodinu.cz/mescon/images/partner_badget/${n}.svg`} alt={`Logo partnera ${n}`} className="h-14 sm:h-16 md:h-20 w-auto opacity-95" />
              ))}
              {/* sekvence 2 */}
              {partners.map((n) => (
                <img key={`s2-${n}`} src={`https://web2.itnahodinu.cz/mescon/images/partner_badget/${n}.svg`} alt="" aria-hidden="true" className="h-14 sm:h-16 md:h-20 w-auto opacity-95" />
              ))}
              {/* sekvence 3 */}
              {partners.map((n) => (
                <img key={`s3-${n}`} src={`https://web2.itnahodinu.cz/mescon/images/partner_badget/${n}.svg`} alt="" aria-hidden="true" className="h-14 sm:h-16 md:h-20 w-auto opacity-95" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-5">
          {[
            ...
            <div key={t} className="rounded-xl border border-[#23283a] bg-[#0f1422]/50 p-5">
              <div className="flex items-start gap-3">
                <span className="mt-1 inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#5885fa]/15 border border-[#5885fa]/35">
                  <svg aria-hidden="true" viewBox="0 0 20 20" className="h-4 w-4 fill-[#eef3fe]"><path d="M16.7 5.3a1 1 0 0 1 0 1.4l-7 7a1 1 0 0 1-1.4 0l-3-3a1 1 0 1 1 1.4-1.4l2.3 2.29 6.3-6.29a1 1 0 0 1 1.4 0Z"/></svg>
                </span>
                <div>
      ...
      <section className="page-container px-6 md:px-10 pb-16">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
          {[
            ...
            <div key={t} className="rounded-xl border border-[#23283a] bg-[#0f1422]/50 p-5">
              <div className="flex items-start gap-3">
                <span className="mt-1 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-[#5885fa]/15 border border-[#5885fa]/35">
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-5 w-5 fill-[#eef3fe]"><path d="M12 2 2 7l10 5 10-5-10-5Zm0 7L2 4v13l10 5 10-5V4l-10 5Z"/></svg>
                </span>
                <div>
                  <h4 className="text-white font-semibold">{t}</h4>
